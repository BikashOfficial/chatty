...
//               <Link to="/login" className='link link-primary'>Login
//               </Link>
//             </p>
//           </div>
//         </div>
...
//         subtitle="Connect with friends, share moments, and stay in touch with your ones."
//       />
//     </div>
//   )
// }
  ...
  const handleSubmit = async (e) => {
    ...
    if (success === true) {
      try {
        ...
        setSignUpError('Failed to create an account. Please try again.'); // Set error message
      }
    }
  };
